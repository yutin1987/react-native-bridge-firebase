...
@interface RNBridgeFirebaseDeviceUID ()
...
@implementation RNBridgeFirebaseDeviceUID
...
+ (NSString *)uid {
    return [[[RNBridgeFirebaseDeviceUID alloc] initWithKey:@"deviceUID"] uid];
}
 ...
 */
- (void)save {
  if (![RNBridgeFirebaseDeviceUID valueForUserDefaultsKey:_uidKey]) {
    [RNBridgeFirebaseDeviceUID setValue:_uid forUserDefaultsKey:_uidKey];
  }
  if (![RNBridgeFirebaseDeviceUID valueForKeychainKey:_uidKey service:_uidKey]) {
    [RNBridgeFirebaseDeviceUID setValue:_uid forKeychainKey:_uidKey inService:_uidKey];
  }
}
